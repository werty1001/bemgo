...
* `npm run clean` — [удаление неиспользованных блоков и элементов](#удаление-неиспользованных-блоков) *
...
.button {
  background-color: transparent; // Это правило уберет фон
}
```
...
# Удаление неиспользованных блоков
